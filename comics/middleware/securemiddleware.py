...
# Configuring CSP example, this is from old 0.2 API, needs to be revised
...
# Disable HSTS as we handle that at the nginx level
secure_headers = secure.Secure(hsts=None)
